            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/40 backdrop-blur-lg border border-white/50 rounded-3xl p-8 shadow-xl space-y-4">
                    <input
                        ...
                        className="w-full bg-white/70 border-white rounded-2xl py-3.5 px-5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none placeholder-accent-sage/50"
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-primary text-white font-bold text-lg py-4 rounded-2xl shadow-lg mt-4 hover:brightness-105 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                    >
